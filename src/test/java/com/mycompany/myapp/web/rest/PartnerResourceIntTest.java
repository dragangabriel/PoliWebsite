...
public class PartnerResourceIntTest {
    ...
    public void setup() {
        ...
        PartnerResource partnerResource = new PartnerResource(partnerRepository);
    ...
    public void createPartner() throws Exception {
        ...
        assertThat(testPartner.getExternalUrl()).isEqualTo(DEFAULT_EXTERNAL_URL);
    }
    ...
    public void updatePartner() throws Exception {
        ...
        assertThat(testPartner.getExternalUrl()).isEqualTo(UPDATED_EXTERNAL_URL);
    }
